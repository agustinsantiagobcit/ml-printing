...
@Entity
@DiscriminatorValue(ElementType.ELEMENT_CARATULA_VIDA_CON_TABLA)
@javax.persistence.Table(name = "SAAM2_ELEMENTO_CARATULA3")
@PrimaryKeyJoinColumn(name = "ID_CARATULA", referencedColumnName = "ID")
public class CaratulaVidaConTabla extends TemplateElement implements Serializable {
    ...
    @Basic
    @Column(name = "prima3")
    public String getPrima3() {
        return prima3;
    }

    public void setPrima3(String prima3) {
        this.prima3 = prima3;
    }
    ...
    public String getXML(Map<String, Object> parameterMap) {
        ...
        String baseXML = "<CaratulaVida>" +
                createTextElement("TipoCaratula", "VidaConTabla") +
                ...
                createTextElement("Prima1", getPrima1()) +
                createTextElement("Prima2", getPrima2()) +
                createTextElement("Prima3", getPrima3()) +
                createTextElement("Plan", getPlan()) +
    ...
    public TemplateElement copy() {
        CaratulaVidaConTabla copy = new CaratulaVidaConTabla();
        ...
        copy.setPrima1(this.getPrima1());
        copy.setPrima2(this.getPrima2());
        copy.setPrima3(this.getPrima3());
